...
export default function BillingShow({
    ...
    const latestPayment = invoice.payments.findLast(
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-5 p-4 md:p-6">
                ...
                <PageHeader
                    ...
                    actions={
                        <Badge
                            variant="outline"
                            className={invoiceTone(invoice.status)}
                        >
                ...
                <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,1fr)_23rem]">
                    <aside className="order-1 grid min-w-0 gap-4 xl:sticky xl:top-5 xl:order-2">
                        {can.receivePayment ? (
                            <PaymentForm
                                key={invoice.uuid}
                                invoice={invoice}
                            ...
                            <section className="bg-card grid gap-3 rounded-xl border p-5">
                                {invoice.status === 'paid' ? (
                                    <>
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            {invoice.total_amount === 0
                                                ...
                                                : 'Pembayaran selesai. Struk tersedia pada riwayat pembayaran.'}
                                        </p>
                                    </>
                                    ...
                                    <>
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            Penerimaan pembayaran memerlukan
                                            akses kasir.
                                        </p>
                                    </>
                                )}
                    ...
                    <main className="order-2 grid min-w-0 gap-4 xl:order-1">
                        ...
                        <section className="bg-card min-w-0 overflow-hidden rounded-xl border">
                            <div className="flex items-center justify-between gap-2 border-b px-4 py-3">
                                ...
                                <span className="text-muted-foreground text-xs">
                                    {invoice.payments.length} transaksi
                                </span>
                            </div>
                            {invoice.payments.length === 0 ? (
                                <p className="text-muted-foreground p-4 text-sm">
                                    Pembayaran yang berhasil akan tampil di
                                    sini.
                                </p>
                            ) : (
                                <div className="divide-y">
    ...
    return (
        <div className="flex items-center justify-between gap-4 text-sm">
            ...
            <span
                className={
                    'tabular-nums ' +
                    (emphasized ? 'text-lg font-semibold' : 'font-medium')
                }
            >
...
function Info({ label, value }: { label: string; value: string }) {
    return (
        <div className="min-w-0">
            ...
            <p className="mt-1 text-sm font-medium break-words tabular-nums">
                {value}
            </p>
        </div>
    );
        ...
        (
            {
                ...
                invoice_voided: 'Tagihan dibatalkan',
